<script lang="ts">
  import { selectedDialogZoneId, selectedDialogZoneScreenPosition, builderEditMode, deleteDialogZone, selectDialogZone, openDialogZonePanel, isDraggingInBuilder } from '../stores/builderStores';
