<script lang="ts">
  import { selectedSocialId, selectedSocial, deletePlacedSocial, selectSocial, updatePlacedSocial } from '../../stores/builderStores';
  import { isSocialPanelOpen, closeSocialPanel } from '../../stores/uiStores';
