<script lang="ts">
  import { selectedFrameId, selectedFrame, deletePlacedFrame, selectFrame, updatePlacedFrame } from '../../stores/builderStores';
  import { builderPreviewLanguage, setBuilderPreviewLanguage, isFramePanelOpen, closeFramePanel } from '../../stores/uiStores';
