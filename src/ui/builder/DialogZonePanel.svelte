<script lang="ts">
  import { selectedDialogZoneId, dialogZones, updateDialogZoneText, deleteDialogZone, updateDialogZone } from '../../stores/builderStores';
  import { isDialogZonePanelOpen, closeDialogZonePanel } from '../../stores/uiStores';
