<script lang="ts">
  import { placedFrames, draggingFramePositions, isBuilderMode } from '../../stores/builderStores';
  import { builderCameraInfo } from '../../stores/gameStores';
  import { builderPreviewLanguage } from '../../stores/uiStores';
